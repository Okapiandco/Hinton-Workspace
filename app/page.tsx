    ...
    <>
      ...
      <HeroSection
        ...
        ctas={[
          ...
          { text: 'Book a Tour', href: spacebringUrl, variant: 'outline-light' },
        ]}
      />
      ...
      <Section>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mt-8">
            <a
              href="https://www.google.com/maps/place/Hinton+Workspace/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 border border-light-pink px-6 py-3 rounded font-sans text-sm text-dark-green hover:bg-cream transition-colors"
            >
